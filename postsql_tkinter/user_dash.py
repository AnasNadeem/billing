...
class UserDash:
    def __init__(self, window, username):
        ...
        # Username Text
        self.admin_dash_text = Label(window, text=f'Welcome {self.username}',font=("Roboto Regular", 18), fg=self.main_white_color,bg=self.main_black_color)
        self.admin_dash_text.place(x=0,y=60)
